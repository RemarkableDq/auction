		...
		<!--  列表-->	
				<dl>
					<dd>
						...
						<input name="username" type="text" class="inputh lf" value="${Useritem.username}" /> 
						<span class="red">${username}</span>
						<div class="lf red laba">用户名要求5~10个字符</div>
					</dd>
					<dd>
						<label> <small>*</small>密码
						</label> 
						<input name="userpassword" type="text" class="inputh lf" value="${Useritem.userpassword}" /> 
					...
					<dd>
						<label> <small>*</small>身份证号
						 ...
						 <input name="usercardno" type="text" class="inputh lf" value="${Useritem.usercardno}" /> 
						 <span class="red">${usercardno}</span>
						 <div class="lf red laba">身份证号要求18位数字</div>
					</dd>
					<dd>
						<label> <small>*</small>电话
						</label> 
						<input name="usertel" type="text" class="inputh lf" value="${Useritem.usertel}" /> 
						<span class="red">${usertel}</span>
						<div class="lf red laba">电话号码要求11位数字</div>
					</dd>
					<dd>
						<label> <small>*</small>住址
						</label> 
						<input name="useraddress" type="text" class="inputh lf" value="${Useritem.useraddress}" />
					</dd>
					<dd>
						<label> <small>*</small>邮政编码
						</label> <input name="userpostnumber" type="text" class="inputh lf" value="${Useritem.userpostnumber}" />
					</dd>
					<!-- 
					<dd class="hegas">
