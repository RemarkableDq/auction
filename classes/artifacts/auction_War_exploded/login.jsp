...
<!-- main begin-->
    ...
    <div class="login">
      <dl>
        ...
        <dd><label for="name">用户名：</label>
        	<input type="text" name="username" class="inputh" value="${LoginItem.username}" id="name"/></dd>
        <dd><label for="password">密 码：</label>
        	<input type="password" name="userpassword" class="inputh" value="${LoginItem.userpassword}" id="password"/></dd>
        <dd>
 ...
 <!--            登录失败时，提示的信息 -->  
           <span style="color: red">${cwMsg}</span>
        </dd>
        <dd class="buttom">
           <input name="" type="submit" value="登 录" class="spbg buttombg f14 lf" />
           
           <input href="" id="register" type="button" value="注 册" onclick="location='register.jsp'" class="spbg buttombg f14 lf" />
